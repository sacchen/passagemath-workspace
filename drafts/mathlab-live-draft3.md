...
Professor Matthias Köppe leads the passagemath undergraduate group, which works on adding features or fixing bugs in the software to make it easier to use. The group also uses passagemath to explore math by writing notebooks and running experiments.
...
https://github.com/passagemath/passagemath/pull/2351
...
https://github.com/passagemath/passagemath/pull/2292
...
Exercise — importerror-fix-pattern: a guided notebook where a new contributor fixes a real instance of the modular-install bug. I endorse this one because it teaches a pattern that generalizes across the codebase.
https://github.com/sacchen/passagemath-workspace/blob/main/exercises/importerror-fix-pattern/importerror-fix-pattern.ipynb

Supporting the team — onboarding/setup docs and a queue of shovel-ready issues with problem descriptions and suggested approaches for new teammates.
...
https://github.com/passagemath/passagemath/pull/2353
...
https://github.com/sacchen/passagemath-workspace/blob/main/projects/lp-level2-prep.md
