...
\title{Contributing to passagemath}
\subtitle{Fixing inline plots in Colab}
\author{Samuel Chen}
\institute{\centering\includegraphics[width=0.2\textwidth]{math_logo.png}}
...
\begin{document}
	...
	\begin{frame}{The problem}
		Plots in Colab showed up as text:
		\vspace{1em}
		\begin{center}
